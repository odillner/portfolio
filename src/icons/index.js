...
const GitHub = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-brand-github" width="100" height="100" viewBox="0 0 24 24" strokeWidth="0.5" stroke="#673AB7" fill="none" strokeLinecap="round" strokeLinejoin="round">
